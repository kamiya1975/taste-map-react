...
export default function FaqPanelContent() {
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: "#fff" }}>
      ...
      >
        <Q>位置情報を許可しないと使えない？</Q>
        <A>許可しなくても利用できます。位置情報は店舗表示および評価記録の目的で取得する場合があり、利用者の同意がある場合に限り取得されます。</A>
        <div style={{ height: 1, background: "rgba(0,0,0,.08)", margin: "20px 0 20px" }} />

        <Q>マップの打点って増やせるの？</Q>
        <A>はい、できます。お気に入り店舗登録パネルで店舗を選択すると、その店舗の取扱商品が打点され、マップの表示商品が増えていきます。<br></br><br></br>
            また、検査により随時打点できる商品を増やしていきます。環境によっては自動で反映されない場合があるため、更新ボタンについてパネルの更新ボタンを押すかアプリのバックグラウンド削除を習慣づけてみてください。
        </A>
        <div style={{ height: 1, background: "rgba(0,0,0,.08)", margin: "20px 0 20px" }} />
        ...
        <Q>検索窓のバーコードボタンは何ができるの？</Q>
        <A>カメラスキャンによるバーコード検索ができます。マップに打点されていなくても商品登録があるものは詳細が表示されます。</A>
        <div style={{ height: 1, background: "rgba(0,0,0,.08)", margin: "20px 0 20px" }} />
