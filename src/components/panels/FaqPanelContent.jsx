  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", background: "#fff" }}>
      ...
      >
        ...
        <A>マップに表示されている商品の一覧です。初めに基準のワインを購入した店舗として選択した店舗と、お気に入り店舗登録で選択した店舗の取扱商品が表示されます。</A>
        <div style={{ height: 1, background: "rgba(0,0,0,.08)", margin: "18px 0 8px" }} />
        ...
        <A>初めに選択した基準のワインを購入した店舗は固定となり取扱解除することはできませんが、それ以外の店舗については、お気に入り店舗登録パネルの星形をタップすることで登録/解除ができます。</A>
        <div style={{ height: 1, background: "rgba(0,0,0,.08)", margin: "18px 0 8px" }} />
        ...
        <A>カメラスキャンによるバーコード検索ができます。マップに表示されていない商品であっても、商品登録がしてあるものは詳細表示することができます。</A>
