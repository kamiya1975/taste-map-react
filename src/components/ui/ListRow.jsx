...
export default function ListRow({
      ...
      >
        <span
          ...
          style={{
            ...
            background: colorCSS, display: "inline-block",
          }}
        />
        {type || "Unknown"}
      </span>
  ...
  return (
    <li
      onClick={() => onPick?.(item)}
      style={{
        padding: "12px 8px 14px 8px", // ← 下に少し余白を足す
        borderBottom: "1px solid #eee",
        cursor: "pointer",
        borderRadius: 6,
        background: "transparent",
        position: "relative",
        paddingRight: 76,             // ◎のぶん右に空ける（size=40なら 72〜80）
      }}
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 6, justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
          <strong style={{ color: "rgb(50,50,50)", fontSize: 16, fontWeight: 700, minWidth: 28, textAlign: "right" }}>
            {index}.
          </strong>
