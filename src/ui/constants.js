...
export const CLUSTER_META = [
  ...
  { id: 5,  name: "3.シャープクリア",     hint: "柑橘の酸味と硬質なキレ。淡色で軽快、透明感のある辛口" },
  { id: 6,  name: "4.軽快まろやか",       hint: "軽快でミルキーさと柑橘が混ざる、柔らかい飲み心地のまろやか" },
  { id: 10, name: "5.穏やかミディアム",    hint: "まろやかな口当たりで、渋み控えめ。柔らかく果実味が広がる" },
  { id: 2,  name: "6.個性派熟成系",       hint: "スモークやミネラルの複雑な香り。辛口で引き締まった熟成タイプ" },
  { id: 3,  name: "7.軽いクリーン",       hint: "香り味わいとも軽やかで控えめ。雑味がなく透明感のあるライト感" },
  { id: 1,  name: "8.円熟中ボディ",       hint: "厚みと甘やかさが調和する、円熟で柔らかく滑らかなリッチ感" },
  { id: 4,  name: "9.濃厚フルボディ",     hint: "濃厚な果実味と樽香のコク。力強く飲みごたえのあるフルボディ" },
