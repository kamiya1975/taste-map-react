...
export const CLUSTER_META = [
  { id: 9,  name: "1.甘口・フルーティー",   hint: "低アルで軽く甘酸っぱく、若々しく爽快なフルーティタイプ" },
  ...
  { id: 10, name: "5.穏やか・ミディアム",    hint: "まろやかな口当たりで、渋み控えめ。柔らかく果実味が広がる" },
  ...
  { id: 8,  name: "10.骨格・スモーキー",     hint: "酸味と骨格が調和し、厚みと熟成感が重なるスモーキーで力強い" },
];
