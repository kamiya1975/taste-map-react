...
export const CLUSTER_META = [
  { id: 6,  name: "甘口・フルーティー", hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 9,  name: "淡麗・フレッシュ白", hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 1,  name: "酸味・シャープ白",   hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 5,  name: "穏やか・まろやか白", hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 8,  name: "熟成・やや複雑白",   hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 4,  name: "軽い・クリーン赤",   hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 2,  name: "穏やか・まろやか赤", hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 10, name: "円熟・中ボディ赤",   hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 7,  name: "濃厚・重ボディ赤", hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
  { id: 3,  name: "骨格・重ボディ赤",   hint: "ここに各グループの解説文が入ります。ここに各グループの解説。" },
];
