...
export const WISH_STAR_SIZE = 0.28; // 0.28〜0.36で好み調整
...
export const CLUSTER_META = [
  ...
  { id: 7,  name: "若飲みフレッシュ", hint: "爽やかなハーブや柑橘の香り。フレッシュですっきり爽快な軽口" },
  { id: 5,  name: "シャープ・クリア",   hint: "柑橘の酸味と硬質なキレ。淡色で軽快、透明感のある辛口" },
  { id: 6,  name: "軽快・まろやか", hint: "軽快でミルキーさと柑橘が混ざる、柔らかい飲み心地のまろやか" },
  { id: 10,  name: "穏やか・ミディアム", hint: "まろやかな口当たりで、渋み控えめ。柔らかく果実味が広がる" },
  { id: 2,  name: "個性派・熟成系",   hint: "スモークやミネラルの複雑な香り。辛口で引き締まった熟成タイプ" },
  { id: 3,  name: "軽い・クリーン",   hint: "香り味わいとも軽やかで控えめ。雑味がなく透明感のあるライト感" },
  { id: 1, name: "円熟・中ボディ",   hint: "厚みと甘やかさが調和する、円熟で柔らかく滑らかなリッチ感" },
  { id: 4,  name: "濃厚・フルボディ", hint: "濃厚な果実味と樽香のコク。力強く飲みごたえのあるフルボディ" },
  { id: 8,  name: "骨格・スモーキー",   hint: "酸味と骨格が調和し、厚みと熟成感が重なるスモーキーで力強い" },
];
