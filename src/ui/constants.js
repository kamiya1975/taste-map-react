...
export const CLUSTER_COLORS_FIXED = {
  1:  [231, 201, 183, 255],  // 甘口・フルーティー
  2:  [195, 218, 147, 255],  // 若飲みフレッシュ
  3:  [112, 175,  84, 255],  // シャープ・クリア
  4:  [235, 220,  80, 255],  // 軽快・まろやか
  5:  [216, 209, 119, 255],  // 穏やか・ミディアム
  6:  [164, 137,  66, 255],  // 個性派・熟成系
  7:  [196,  73,  75, 255],  // 軽い・クリーン
  8:  [113,  77, 126, 255],  // 円熟・中ボディ
  9:  [ 41,  23,  47, 255],  // 濃厚・フルボディ
  10:  [108,  38,  38, 255],  // 骨格・スモーキー
};
