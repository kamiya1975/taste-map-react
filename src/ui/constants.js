...
export const CLUSTER_COLORS_FIXED = {
  ...
  1:  [112, 175,  84, 255],  5:  [216, 209, 119, 255],   
  8:  [164, 137,  66, 255],  4:  [196,  73,  75, 255],
  2:  [192, 136, 160, 255],  10: [113,  77, 126, 255],
...
export const CLUSTER_META = [
  { id: 6,  name: "甘口・フルーティー", hint: "低アルで軽く甘酸っぱく、若々しく爽快なフルーティタイプ" },
  { id: 4,  name: "軽い・クリーン赤",   hint: "香り味わいとも軽やかで控えめ。雑味がなく透明感のあるライト赤" },
  { id: 9,  name: "若飲みフレッシュ白", hint: "爽やかなハーブや柑橘の香り。フレッシュですっきり爽快な軽白" },
  { id: 2,  name: "穏やか・まろやか赤", hint: "まろやかな口当たりで、渋み控えめ。柔らかく果実味が広がる赤" },
  { id: 1,  name: "シャープ・クリア辛白",   hint: "柑橘の酸味と硬質なキレ。淡色で軽快、透明感のある辛口白" },
  { id: 10, name: "円熟・中ボディ赤",   hint: "厚みと甘やかさが調和する、円熟で柔らかく滑らかなリッチな赤" },
  { id: 5,  name: "穏やか・まろやか白", hint: "軽快でミルキーさと柑橘が混ざる、柔らかい飲み心地のまろやか白" },
  { id: 7,  name: "濃厚・フルボディ赤", hint: "濃厚な果実味と樽香のコク。力強く飲みごたえのあるフルボディ赤" },
  { id: 8,  name: "個性派・熟成系",   hint: "スモークやミネラルの複雑な香り。辛口で引き締まった熟成タイプ" },
  { id: 3,  name: "骨格・スモーキー赤",   hint: "酸味と骨格が調和し、厚みと熟成感が重なるスモーキーで力強い赤" },
];
